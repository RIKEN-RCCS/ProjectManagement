...
python3 scripts/pm_ingest.py slack --slack-channel <CHANNEL_ID> --since 2026-01-01
python3 scripts/pm_ingest.py slack --slack-channel <CHANNEL_ID> --slack-force-reextract
python3 scripts/pm_ingest.py slack --slack-channel <CHANNEL_ID> --slack-list
