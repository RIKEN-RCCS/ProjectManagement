...
平日 17:00 に **本日のみ**のデータで日次サマリーを生成し Canvas（`F0ATCN7E2D9`: リーダー会議Canvas）に投稿する。
...
- `pm_argus.py --brief-to-canvas --today-only --canvas-id F0ATCN7E2D9` を実行
...
indices:
  ...
  pm-hpc:
    ...
    channels: [C08LSJP4R6K, C093DQFSCRH, C093LP1J15G, C08MJ0NF5UZ, C096ER1A0LU]
  ...
  pm-all:
    ...
    channels: [C08M0249GRL, C08SXA4M7JT, C08LSJP4R6K, ...]
