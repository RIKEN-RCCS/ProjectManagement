...
#
# Usage:
#   bash scripts/sync_and_report.sh --db data/pm.db --canvas-id <CANVAS_ID>
#   bash scripts/sync_and_report.sh --db data/pm.db --canvas-id <CANVAS_ID> --since 2026-03-01
#   bash scripts/sync_and_report.sh --db data/pm.db --canvas-id <CANVAS_ID> --dry-run
#   bash scripts/sync_and_report.sh --db data/pm.db --canvas-id <CANVAS_ID> --skip-sync
#
# Options:
