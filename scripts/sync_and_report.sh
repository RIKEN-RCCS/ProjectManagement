...
#
# Usage:
#   bash scripts/sync_and_report.sh --db data/pm.db --canvas-id F0AAD2494VB
#   bash scripts/sync_and_report.sh --db data/pm.db --canvas-id F0AAD2494VB --since 2026-03-01
#   bash scripts/sync_and_report.sh --db data/pm.db --canvas-id F0AAD2494VB --dry-run
#   bash scripts/sync_and_report.sh --db data/pm.db --canvas-id F0AAD2494VB --skip-sync
#
# Options:
