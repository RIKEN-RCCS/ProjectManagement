...
Usage:
    python3 scripts/canvas_debug.py --canvas-id <CANVAS_ID>
    python3 scripts/canvas_debug.py --canvas-id <CANVAS_ID> --show-raw
    python3 scripts/canvas_debug.py --canvas-id <CANVAS_ID> --delete-all
    python3 scripts/canvas_debug.py --canvas-id <CANVAS_ID> --recreate
    python3 scripts/canvas_debug.py --canvas-id <CANVAS_ID> --recreate --title "Summary"
