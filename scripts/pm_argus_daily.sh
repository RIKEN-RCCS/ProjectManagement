...
python3 /lvs0/rccs-nghpcadu/hikaru.inoue/ProjectManagement/scripts/argus/pm_argus.py --brief-to-canvas --canvas-id F0ATCN7E2D9 >> $LOGFILE 2>&1
python3 /lvs0/rccs-nghpcadu/hikaru.inoue/ProjectManagement/scripts/argus/pm_argus.py --risk --canvas-id F0ATN63JQV7 >> $LOGFILE 2>&1
